...
contract CoinToken is ERC20, Ownable {
    ...
    constructor() ERC20("floski", "ski")  {
        rewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;// put reward token address here
        _marketingWalletAddress = 0xA040fa7897e322f5b8C3dd3444fAcF2333c1a081;// put marketing wallet here
        ...
        // YOU CAN CHANGE SWAP LIMIT LIKE THIS
       //swapTokensAtAmount = 100000 * (10**18);
        ...
        _maxWalletLimit = 1000000000* (10**18);
